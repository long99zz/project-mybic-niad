...
const insuranceOptions = Array.from({ length: 20 }, (_, i) => {
  ...
  return {
    value,
    label: value.toLocaleString("vi-VN") + " VNĐ/người",
    benefit: {
      soTien: value.toLocaleString("vi-VN") + " VNĐ",
...
const calcFee = (num: number, amount: number) => {
  ...
  const rate = amount <= 100_000_000 ? 0.0028 : 0.005;
  return Math.round(amount * rate * num);
};

const GPAOrderPage: React.FC = () => {
  ...
  // Tính phí theo thời hạn
  const periodFee =
    insuranceDuration < 10
      ? Math.round((insuranceDuration / 10) * annualFee)
      : annualFee;
  ...
  const handleCustomerInfoChange = (
    field: keyof typeof accountInfo,
    value: any
  ) => {
              ...
              <div className="space-y-8">
                ...
                <div className="bg-[#F4F6F8] p-6 rounded-lg">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex items-center gap-8 mt-4">
                      ...
                      <div className="flex-1">
                        <select
                          ...
                          onChange={(e) =>
                            setInsuranceDuration(Number(e.target.value))
                          }
                          className="w-full px-3 py-2 border border-gray-300 rounded-md text-base"
                        >
                    ...
                    {/* Tổng phí bảo hiểm theo thời hạn */}
                    <div className="bg-white rounded-2xl shadow-lg p-6 text-left mt-4 mb-4">
                      <p className="text-lg">
                        Tổng phí (miễn VAT):
                        <span className="text-red-600 font-bold ml-2">
                          {periodFee.toLocaleString("vi-VN")} VNĐ
                        </span>
                      </p>
                      <p className="text-lg">
                        Số tiền chiết khấu:
                      ...
                      <p className="text-xl font-bold">
                        ...
                        <span className="text-red-600 ml-2">
                          {(periodFee - discount).toLocaleString("vi-VN")} VNĐ
                        </span>
                      </p>
                    </div>
                  </div>
